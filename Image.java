 ...
 *         img.setRectangle(10, 20, 50, 30, Color.YELLOW); // Color should be
 *         imported with `import java.awt.Color`
 *         img.save("test.png");
 *         ```
 */
public class Image {
  ...
  /**
   * Constructs an empty image (initially black) of width `width` and height
   * `height`
   */
   ...
   * WARNING : NO CHECK IS DONE. IF YOU WRITE OUTSIDE THE IMAGE IT WILL RAISE AN
   * ERROR
   */
